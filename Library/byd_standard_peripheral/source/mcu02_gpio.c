...
{	
	...
	{
		case GPIOA:
			value = DATAA & gpio_pin ? 1 : 0;break;
		case GPIOB:
			value = DATAB & gpio_pin ? 1 : 0;break;
		case GPIOC:
			value = DATAC & gpio_pin ? 1 : 0;break;		
		case GPIOE:
			value = DATAE & gpio_pin ? 1 : 0;break;
		case GPIOF:
			value = DATAF & gpio_pin ? 1 : 0;break;
		case GPIOG:
			value = DATAG & gpio_pin ? 1 : 0;break;
		case GPIOH:
			value = DATAH & gpio_pin ? 1 : 0;break;
		default:
			break;
	}
	return value;
