...
void dqiot_drv_gpio_init(void)
{
	...
	gpio_init(VBAT_TEST_PORT,VBAT_TEST_PIN,GPIO_MODE_IN_FLOATING);
	...
	gpio_init(WIFI_SDA_PORT,WIFI_SDA_PIN,GPIO_MODE_IN_FLOATING);
	//gpio_bit_reset(WIFI_SDA_PORT,WIFI_SDA_PIN);

	gpio_init(WIFI_SCL_PORT,WIFI_SCL_PIN,GPIO_MODE_IN_FLOATING);
	//gpio_bit_reset(WIFI_SCL_PORT,WIFI_SCL_PIN);
