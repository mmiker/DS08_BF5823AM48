...
typedef enum
{
	...
	SYS_STATUS_CLR_PWD = 0x04,

	SYS_STATUS_INPUT_FP = 0x11,
	SYS_STATUS_ADD_FP = 0x12,
	SYS_STATUS_DEL_FP = 0x13,
	SYS_STATUS_CLR_FP = 0x14,

	SYS_STATUS_INPUT_RFID = 0x21,
	SYS_STATUS_ADD_RFID = 0x22,
	SYS_STATUS_DEL_RFID = 0x23,
	SYS_STATUS_CLR_RFID = 0x24,

	SYS_STATUS_DOOR_OPEN = 0x30,
	SYS_STATUS_RESTORE_LOCK = 0x31,
	
	SYS_STATUS_ENTER_SLEEP = 0x50,
