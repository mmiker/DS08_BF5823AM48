...
void dqiot_drv_uart0_isr(void) interrupt 17
{
	...
	{
		//uart_get_buf[uart_buf_len++] = UART0_BUF;
...
return :
	none
*/
void dqiot_drv_check_uart0_data(void)
{
//	if(uart_buf_len >= UART0_DATA_LEN)
//		return ;
//	else 
//		uart_get_buf[uart_buf_len++] = uart_rx_byte(UART0);
	return;
}
...
void dqiot_uart0_sendData(unsigned char *p_data, unsigned char length)
{
	unsigned char i = 0;
