...
//---------------------------------------------------
	...
	AUD_ID_PWD_NOT_SAME_RETRY		= 131+AUD_BASE_ID_MAX,//两次输入的密码不一致,请重新输入
	...
	AUD_ID_PWD_NOT_EXIST 			= 18+AUD_BASE_ID_MAX,//密码不存在，请重新输入
	...
	AUD_ID_ADD_FAIL_RETRY 			= 36+AUD_BASE_ID_MAX,//添加失败，请重试
	AUD_ID_FP_TWICE_NOT_SAME		= 57+AUD_BASE_ID_MAX,//两次输入的指纹不一致
	...
	AUD_ID_SYSTEM = 138+AUD_BASE_ID_MAX,//系统
	AUD_ID_SYSTEM2 = 93+AUD_BASE_ID_MAX,//系统2
	AUD_ID_SYS_PASSWORD = 101+AUD_BASE_ID_MAX,//密码
	AUD_ID_SYS_FP = 111+AUD_BASE_ID_MAX,//指纹
	AUD_ID_SYS_RFCARD = 121+AUD_BASE_ID_MAX,//RF卡
	AUD_ID_SYS_ADMIN = 63+AUD_BASE_ID_MAX,//管理员
	AUD_ID_SYS_ADMIN2 = 134+AUD_BASE_ID_MAX,//管理员
...
return :
	none
*/
void mmi_dq_aud_play_with_id(uint8_t aud_id);
uint8_t mmi_dq_aud_get_state(void);
