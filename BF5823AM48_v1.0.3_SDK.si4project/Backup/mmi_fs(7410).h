...
return :
	none
*/
void mmi_dq_fds_read(unsigned char page,unsigned int addr, unsigned char * data ,unsigned int size);
...
return :
	none
*/
RET_VAL mmi_dq_fds_write(unsigned char page,unsigned int addr, unsigned char * data ,unsigned int size);
