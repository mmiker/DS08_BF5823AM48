...
void dqiot_drv_gpio_init(void)
{
	...
	gpio_init(VBAT_ADC_PORT,VBAT_ADC_PIN,GPIO_MODE_OUT);
	...
	gpio_init(SW_PORT,SW_PIN,GPIO_MODE_OUT);
...
void dqiot_drv_wake_up(void)
{
	...
	dqiot_drv_uart0A_init();//dqiot_drv_uart0B_init();
