...
return :
	none
*/
uint8_t mmi_dq_key_get_value(void)
{
	#if 0
	#ifdef BYD_CTK_ENABLE
	//CSD_ENABLE()();
	//byd_ctk_normal();
	if(dqiot_drv_get_touch_flag())
	{
...
return :
	none
*/
uint8_t mmi_dq_get_key_map(unsigned char index)
{
	uint8_t key_val = KEY_INVALID;
