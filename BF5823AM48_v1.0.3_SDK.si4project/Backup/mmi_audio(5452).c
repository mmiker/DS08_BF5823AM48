...
const unsigned char aud_play_arr[] = 
{
	...
	AUD_BASE_ID_SYS_NUM_4,AUD_BASE_ID_SYS_CLR_PWD,AUD_BASE_ID_INPUT_BACK,0,		//AUD_ID_SYS_PASSWORD = 101,//密码
	...
	AUD_BASE_ID_SYS_NUM_4,AUD_BASE_ID_SYS_CLR_FP,AUD_BASE_ID_INPUT_BACK,0,			//AUD_ID_SYS_FP = 111,//指纹
	...
	AUD_BASE_ID_SYS_NUM_4,AUD_BASE_ID_SYS_CLR_RFCARD,AUD_BASE_ID_INPUT_BACK,0,		//AUD_ID_SYS_RFCARD = 121,//RF卡


	AUD_BASE_ID_NOT_SAME,AUD_BASE_ID_REINPUT,0,//AUD_ID_PWD_NOT_SAME_RETRY	 = 131//两次输入的密码不一致,请重新输入

	AUD_BASE_ID_SYS_NUM_1,AUD_BASE_ID_SYS_CHG_ADMIN_PWD,
	AUD_BASE_ID_INPUT_BACK,0,		//AUD_ID_SYS_ADMIN = 134,//管理员
#if 0
	...
	AUD_BASE_ID_SYS_NUM_6,AUD_BASE_ID_SYS_RESTORE,AUD_BASE_ID_INPUT_BACK,0,		//AUD_ID_SYSTEM = 138,//系统
#else 
	AUD_BASE_ID_SYS_NUM_1,AUD_BASE_ID_SYS_PASSWORD,
	...
	AUD_BASE_ID_SYS_NUM_5,AUD_BASE_ID_SYS_RESTORE,AUD_BASE_ID_INPUT_BACK,0,		//AUD_ID_SYSTEM = 138,//系统
#endif
#else
	AUD_BASE_ID_SYS_NUM_1,AUD_BASE_ID_SYS_PASSWORD,
	AUD_BASE_ID_SYS_NUM_2,AUD_BASE_ID_SYS_FP,
