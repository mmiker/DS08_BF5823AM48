...
{
	// dqiot_drv_log_output_data('!',fp_index);
	// dqiot_drv_log_output_data('!',type);
	// dqiot_drv_log_output_data('!',MMI_DQ_FS_FP_MAX_NUM);
	// dqiot_drv_log_output_data('!',g_dq_fs_fp[fp_index].fp_index); //0xff
	// dqiot_drv_log_output_data('!',g_dq_fs_fp[fp_index].flag); //0xff
	// dqiot_drv_log_output_data('!',FDS_USE_TYPE_ALL);
